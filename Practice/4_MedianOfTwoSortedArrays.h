...
double calculateMedianOfEvenArray(vector<int>& nums1, vector<int>& nums2, const int& leftChunkSize, const int& end1)
{
	int leftNum;
	int rightNum;
	if (end1 <= 0)
...
double calculateMedianOfUnevenArray(vector<int>& nums1, vector<int>& nums2, const int& leftChunkSize, const int& end1)
{
	if (end1 <= 0)
	{
...
int findNumberOfLeftItemsOfFirstArray(vector<int>& nums1, vector<int>& nums2, const int& leftChunkSize)
{
...
double findMedianSortedArrays(vector<int>& nums1, vector<int>& nums2)
{
	...
	int end1 = findNumberOfLeftItemsOfFirstArray(nums1, nums2, leftChunkSize);

	if ((nums1.size() + nums2.size()) % 2 == 0)
	{
		return calculateMedianOfEvenArray(nums1, nums2, leftChunkSize, end1);
	}
	else
	{
		return calculateMedianOfUnevenArray(nums1, nums2, leftChunkSize, end1);
	}
